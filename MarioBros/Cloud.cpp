...
void Cloud::Render()
{
	...
	case(25):
		...
		_sprite->Draw(_x + _width / 4, _y, ZOOM, ZOOM, _ani->GetRect(1), 1);
		_sprite->Draw(_x + _width / 4 * 2, _y, ZOOM, ZOOM, _ani->GetRect(2), 1);
		_sprite->Draw(_x + _width / 4 * 3, _y, ZOOM, ZOOM, _ani->GetRect(3), 1);
		break;
	case(26):
